      ...
      <div id="ccp-1" class="canvas-create-project" :class="{active: formPart==1, past:formPart == 2 || formPart == 3}" ref="ccp_1">
        ...
        <div class="ccp-form">
            ...
            <div v-if="project.image_or_video == 'image'" class="ccp-form-unit">
              ...
              <el-upload action="https://jsonplaceholder.typicode.com/posts/" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" :file-list="project.image">
  <el-button size="small" type="primary">Click to upload</el-button>
  <div slot="tip" class="el-upload__tip">does this need some text here?</div>
</el-upload>
            </div>
      ...
      <div id="ccp-2" class="canvas-create-project" :class="{active: formPart==2, past:formPart == 3}"  ref="ccp_2">
          ...
          <div class="flex flex-jc-sb width-100">
            <div class="ccp-form-unit width-50">
              ...
              <el-date-picker v-model="project.start_date" type="datetime" placeholder="Select date and time"></el-date-picker>
            </div>
            <div class="ccp-form-unit width-50">
              <label class="label">End Date <span class="required">*</span></label>
              <el-date-picker v-model="project.end_date" type="datetime" placeholder="Select date and time"></el-date-picker>
            </div>
            <div class="ccp-form-unit">
...
export default {
  ...
  methods: {
    ...
    handleRemove(file, fileList) {
      ...
      finish(){
          //first check form
          this.$emit('projectCreated',this.project.name)
      }
  },
  mounted(){
    let ctx = this

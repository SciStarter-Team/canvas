<template>
  <div id="canvas-create">
      ...
      <template v-if="showForm">
          <CreateProjectForm :user="user" :organization="organization" @projectCreated="giveSuccess" :edit="projectToEdit" @cancel="cancelForm" />
      </template>
...
export default {
  ...
  data: function(){
    return {
      showForm: false,
      finished: null,
      user_projects: store.broward.custom,
      projectToEdit: null
    }
  },
  methods: {
